...
def sqrt_quad_example(n, d, no_vars, region, max_func_evals,
    ...
    with a square root of a quadratic response function with noise.
    """
    np.random.seed(seed)
...
if __name__ == "__main__":
    ...
    sqrt_quad_example(n, d, no_vars, region, max_func_evals,
                      seed, lambda_min, lambda_max, mu, sd)
